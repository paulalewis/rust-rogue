...
static things: [ObjInfo; NUMTHINGS] = [
    ...
    ObjInfo { name: String::new(), prob: 36, worth: 0, guess: String::new(), know: false },	/* scroll */
    ObjInfo { name: String::new(), prob: 16, worth: 0, guess: String::new(), know: false },	/* food */
    ObjInfo { name: String::new(), prob: 7, worth: 0, guess: String::new(), know: false },	/* weapon */
    ObjInfo { name: String::new(), prob: 7, worth: 0, guess: String::new(), know: false },	/* armor */
    ObjInfo { name: String::new(), prob: 4, worth: 0, guess: String::new(), know: false },	/* ring */
    ObjInfo { name: String::new(), prob: 4, worth: 0, guess: String::new(), know: false },	/* stick */
];
...
lazy_static! {
    static ref arm_info: [ObjInfo; MAXARMORS] = [
        ...
        ObjInfo { name: String::from("ring mail"), prob: 15, worth: 25, guess: String::new(), know: false },
        ObjInfo { name: String::from("studded leather armor"), prob: 15, worth: 20, guess: String::new(), know: false },
        ObjInfo { name: String::from("scale mail"), prob: 13, worth: 30, guess: String::new(), know: false },
        ObjInfo { name: String::from("chain mail"), prob: 12, worth: 75, guess: String::new(), know: false },
        ObjInfo { name: String::from("splint mail"), prob: 10, worth: 80, guess: String::new(), know: false },
        ObjInfo { name: String::from("banded mail"), prob: 10, worth: 90, guess: String::new(), know: false },
        ObjInfo { name: String::from("plate mail"), prob: 5, worth: 150, guess: String::new(), know: false },
    ];
}
...
lazy_static! {
    static ref pot_info: [ObjInfo; MAXPOTIONS] = [
        ...
        ObjInfo { name: String::from("hallucination"), prob: 8, worth: 5, guess: String::new(), know: false },
        ObjInfo { name: String::from("poison"), prob: 8, worth: 5, guess: String::new(), know: false },
        ObjInfo { name: String::from("gain strength"), prob: 13, worth: 150, guess: String::new(), know: false },
        ObjInfo { name: String::from("see invisible"), prob: 3, worth: 100, guess: String::new(), know: false },
        ObjInfo { name: String::from("healing"), prob: 13, worth: 130, guess: String::new(), know: false },
        ObjInfo { name: String::from("monster detection"), prob: 6, worth: 130, guess: String::new(), know: false },
        ObjInfo { name: String::from("magic detection"), prob: 6, worth: 105, guess: String::new(), know: false },
        ObjInfo { name: String::from("raise level"), prob: 2, worth: 250, guess: String::new(), know: false },
        ObjInfo { name: String::from("extra healing"), prob: 5, worth: 200, guess: String::new(), know: false },
        ObjInfo { name: String::from("haste self"), prob: 5, worth: 190, guess: String::new(), know: false },
        ObjInfo { name: String::from("restore strength"), prob: 13, worth: 130, guess: String::new(), know: false },
        ObjInfo { name: String::from("blindness"), prob: 5, worth: 5, guess: String::new(), know: false },
        ObjInfo { name: String::from("levitation"), prob: 6, worth: 75, guess: String::new(), know: false },
    ];
}
...
lazy_static! {
    static ref ring_info: [ObjInfo; MAXRINGS] = [
        ...
        ObjInfo { name: String::from("add strength"), prob: 9, worth: 400, guess: String::new(), know: false },
        ObjInfo { name: String::from("sustain strength"), prob: 5, worth: 280, guess: String::new(), know: false },
        ObjInfo { name: String::from("searching"), prob: 10, worth: 420, guess: String::new(), know: false },
        ObjInfo { name: String::from("see invisible"), prob: 10, worth: 310, guess: String::new(), know: false },
        ObjInfo { name: String::from("adornment"), prob: 1, worth: 10, guess: String::new(), know: false },
        ObjInfo { name: String::from("aggravate monster"), prob: 10, worth: 10, guess: String::new(), know: false },
        ObjInfo { name: String::from("dexterity"), prob: 8, worth: 440, guess: String::new(), know: false },
        ObjInfo { name: String::from("increase damage"), prob: 8, worth: 400, guess: String::new(), know: false },
        ObjInfo { name: String::from("regeneration"), prob: 4, worth: 460, guess: String::new(), know: false },
        ObjInfo { name: String::from("slow digestion"), prob: 9, worth: 240, guess: String::new(), know: false },
        ObjInfo { name: String::from("teleportation"), prob: 5, worth: 30, guess: String::new(), know: false },
        ObjInfo { name: String::from("stealth"), prob: 7, worth: 470, guess: String::new(), know: false },
        ObjInfo { name: String::from("maintain armor"), prob: 5, worth: 380, guess: String::new(), know: false },
    ];
}
...
lazy_static! {
    static ref scr_info: [ObjInfo; MAXSCROLLS] = [
        ...
        ObjInfo { name: String::from("magic mapping"), prob: 4, worth: 150, guess: String::new(), know: false },
        ObjInfo { name: String::from("hold monster"), prob: 2, worth: 180, guess: String::new(), know: false },
        ObjInfo { name: String::from("sleep"), prob: 3, worth: 5, guess: String::new(), know: false },
        ObjInfo { name: String::from("enchant armor"), prob: 7, worth: 160, guess: String::new(), know: false },
        ObjInfo { name: String::from("identify potion"), prob: 10, worth: 80, guess: String::new(), know: false },
        ObjInfo { name: String::from("identify scroll"), prob: 10, worth: 80, guess: String::new(), know: false },
        ObjInfo { name: String::from("identify weapon"), prob: 6, worth: 80, guess: String::new(), know: false },
        ObjInfo { name: String::from("identify armor"), prob: 7, worth: 100, guess: String::new(), know: false },
        ObjInfo { name: String::from("identify ring, wand or staff"), prob: 10, worth: 115, guess: String::new(), know: false },
        ObjInfo { name: String::from("scare monster"), prob: 3, worth: 200, guess: String::new(), know: false },
        ObjInfo { name: String::from("food detection"), prob: 2, worth: 60, guess: String::new(), know: false },
        ObjInfo { name: String::from("teleportation"), prob: 5, worth: 165, guess: String::new(), know: false },
        ObjInfo { name: String::from("enchant weapon"), prob: 8, worth: 150, guess: String::new(), know: false },
        ObjInfo { name: String::from("create monster"), prob: 4, worth: 75, guess: String::new(), know: false },
        ObjInfo { name: String::from("remove curse"), prob: 7, worth: 105, guess: String::new(), know: false },
        ObjInfo { name: String::from("aggravate monsters"), prob: 3, worth: 20, guess: String::new(), know: false },
        ObjInfo { name: String::from("protect armor"), prob: 2, worth: 250, guess: String::new(), know: false },
    ];
}
...
lazy_static! {
    static ref weap_info: [ObjInfo; MAXWEAPONS + 1] = [
        ...
        ObjInfo { name: String::from("long sword"), prob: 11, worth: 15, guess: String::new(), know: false },
        ObjInfo { name: String::from("short bow"), prob: 12, worth: 15, guess: String::new(), know: false },
        ObjInfo { name: String::from("arrow"), prob: 12, worth: 1, guess: String::new(), know: false },
        ObjInfo { name: String::from("dagger"), prob: 8, worth: 3, guess: String::new(), know: false },
        ObjInfo { name: String::from("two handed sword"), prob: 10, worth: 75, guess: String::new(), know: false },
        ObjInfo { name: String::from("dart"), prob: 12, worth: 2, guess: String::new(), know: false },
        ObjInfo { name: String::from("shuriken"), prob: 12, worth: 5, guess: String::new(), know: false },
        ObjInfo { name: String::from("spear"), prob: 12, worth: 5, guess: String::new(), know: false },
...
lazy_static! {
    static ref ws_info: [ObjInfo; MAXSTICKS] = [
        ...
        ObjInfo { name: String::from("invisibility"), prob: 6, worth: 5, guess: String::new(), know: false },
        ObjInfo { name: String::from("lightning"), prob: 3, worth: 330, guess: String::new(), know: false },
        ObjInfo { name: String::from("fire"), prob: 3, worth: 330, guess: String::new(), know: false },
        ObjInfo { name: String::from("cold"), prob: 3, worth: 330, guess: String::new(), know: false },
        ObjInfo { name: String::from("polymorph"), prob: 15, worth: 310, guess: String::new(), know: false },
        ObjInfo { name: String::from("magic missile"), prob: 10, worth: 170, guess: String::new(), know: false },
        ObjInfo { name: String::from("haste monster"), prob: 10, worth: 5, guess: String::new(), know: false },
        ObjInfo { name: String::from("slow monster"), prob: 11, worth: 350, guess: String::new(), know: false },
        ObjInfo { name: String::from("drain life"), prob: 9, worth: 300, guess: String::new(), know: false },
        ObjInfo { name: String::from("nothing"), prob: 1, worth: 5, guess: String::new(), know: false },
        ObjInfo { name: String::from("teleport away"), prob: 6, worth: 340, guess: String::new(), know: false },
        ObjInfo { name: String::from("teleport to"), prob: 6, worth: 50, guess: String::new(), know: false },
        ObjInfo { name: String::from("cancellation"), prob: 5, worth: 280, guess: String::new(), know: false },
    ];
}
...
lazy_static! {
    static ref helpstr: [HList; 66] = [
        ...
        HList { ch: '!', desc: String::from("shell escape"), print: true },
