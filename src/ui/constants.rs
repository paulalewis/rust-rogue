...
pub const SCROLL_DISPLAY_NAME_MONSTER_CONFUSION: &str = "monster confusion";
pub const SCROLL_DISPLAY_NAME_MAGIC_MAPPING: &str = "magic mapping";
pub const SCROLL_DISPLAY_NAME_HOLD_MONSTER: &str = "hold monster";
pub const SCROLL_DISPLAY_NAME_SLEEP: &str = "sleep";
pub const SCROLL_DISPLAY_NAME_ENCHANT_ARMOR: &str = "enchant armor";
pub const SCROLL_DISPLAY_NAME_IDENTIFY_POTION: &str = "identify potion";
pub const SCROLL_DISPLAY_NAME_IDENTIFY_SCROLL: &str = "identify scroll";
pub const SCROLL_DISPLAY_NAME_IDENTIFY_WEAPON: &str = "identify weapon";
pub const SCROLL_DISPLAY_NAME_IDENTIFY_ARMOR: &str = "identify armor";
pub const SCROLL_DISPLAY_NAME_IDENTIFY_STICK: &str = "identify ring, wand or staff";
pub const SCROLL_DISPLAY_NAME_SCARE_MONSTER: &str = "scare monster";
pub const SCROLL_DISPLAY_NAME_FOOD_DETECTION: &str = "food detection";
pub const SCROLL_DISPLAY_NAME_TELEPORTATION: &str = "teleportation";
pub const SCROLL_DISPLAY_NAME_ENCHANT_WEAPON: &str = "enchant weapon";
pub const SCROLL_DISPLAY_NAME_CREATE_MONSTER: &str = "create monster";
pub const SCROLL_DISPLAY_NAME_REMOVE_CURSE: &str = "remove curse";
pub const SCROLL_DISPLAY_NAME_AGGRAVATE_MONSTERS: &str = "aggravate monsters";
pub const SCROLL_DISPLAY_NAME_PROTECT_ARMOR: &str = "protect armor";
    
pub const WEAPON_DISPLAY_NAME_MACE: &str = "mace";
pub const WEAPON_DISPLAY_NAME_LONG_SWORD: &str = "long sword";
pub const WEAPON_DISPLAY_NAME_SHORT_BOW: &str = "short bow";
pub const WEAPON_DISPLAY_NAME_ARROW: &str = "arrow";
pub const WEAPON_DISPLAY_NAME_DAGGER: &str = "dagger";
pub const WEAPON_DISPLAY_NAME_TWO_HANDED_SWORD: &str = "two handed sword";
pub const WEAPON_DISPLAY_NAME_DART: &str = "dart";
pub const WEAPON_DISPLAY_NAME_SHURIKEN: &str = "shuriken";
pub const WEAPON_DISPLAY_NAME_SPEAR: &str = "spear";

pub const STICK_DISPLAY_NAME_LIGHT: &str = "light";
pub const STICK_DISPLAY_NAME_INVISIBLE: &str = "invisibility";
pub const STICK_DISPLAY_NAME_LIGHTNING: &str = "lightning";
pub const STICK_DISPLAY_NAME_FIRE: &str = "fire";
pub const STICK_DISPLAY_NAME_COLD: &str = "cold";
pub const STICK_DISPLAY_NAME_POLYMORPH: &str = "polymorph";
pub const STICK_DISPLAY_NAME_MAGIC_MISSILE: &str = "magic missile";
pub const STICK_DISPLAY_NAME_HASTE_MONSTER: &str = "haste monster";
pub const STICK_DISPLAY_NAME_SLOW_MONSTER: &str = "slow monster";
pub const STICK_DISPLAY_NAME_DRAIN_LIFE: &str = "drain life";
pub const STICK_DISPLAY_NAME_NOTHING: &str = "nothing";
pub const STICK_DISPLAY_NAME_TELEPORT_AWAY: &str = "teleport away";
pub const STICK_DISPLAY_NAME_TELEPORT_TO: &str = "teleport to";
pub const STICK_DISPLAY_NAME_CANCELLATION: &str = "cancellation";